...
public class ResultaatControleConfiguration implements Serializable {
	...
	@Comment("Schakelt de uitgebreide controle van de resultaten in. Deze controle is langzaam, maar kan databasecorruptie voorkomen bij fouten in de software.")
